...
DOWNLOAD_URL="https://github.com/mundialtecdev/pro/raw/main/pro.zip"


curl -fL --progress-bar "$DOWNLOAD_URL" -o /tmp/pro.zip || {
...
PASSWORD=$(journalctl -u o11pro -n 200 --no-pager | grep "Use temporary account" | tail -1 | awk -F'admin / ' '{print $2}')
